...
// BUTTONS -----------------------------------------------------------------------------
  ...
  async clickExportButton() {
    ...
    await exportButton.waitFor({ state: 'visible' }); // Ensure the button is visible
    const downloadPromise = this.page.waitForEvent('download'); // Wait for the download event
    await exportButton.click(); // Click the button
