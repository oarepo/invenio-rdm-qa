...
// VERIFICATION ------------------------------------------------------------------------
  ...
  async isNewVersionDraftLabelPresent(): Promise<boolean> {
   ...
   // Method to check if a specific title matches the text of an <a> element
   async isRecordTitleMatching(): Promise<boolean> {
    const recordLink = this.page.locator('a.truncate-lines-2'); // CSS selector for your link
