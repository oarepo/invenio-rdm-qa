...
// FIELDS ------------------------------------------------------------------------------  
  ...
  async selectCuratorRole() {
    // Locate the radio button using the input's `aria-label` attribute and click it
    await this.page.locator('input[aria-label="Curator"]').click();
  }
...
// BUTTONS -----------------------------------------------------------------------------
  ...
  // Method to click the 'Invite' button
