...
export class UploadPage {
  ...
  // Method to click Description button
  async clickDescription() {
    const frame = this.page.frameLocator('#tiny-react_71952625411728987215469_ifr');
    await frame.locator('//body[@id="tinymce"]').fill('This is a sample description');
  }
