...
// VERIFICATION ------------------------------------------------------------------------
 ...
 getCommunityName(expectedCommunityName: string) {
  return this.page.locator(`div.ui.small.header > a.ui.small.header`, { hasText: expectedCommunityName });
}
 ...
 async verifyCommunityName(expectedCommunityName: string) {
  ...
  await expect(communityNameLocator).toHaveText(expectedCommunityName, { timeout: 5000 });
}
}