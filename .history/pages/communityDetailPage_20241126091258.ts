...
// VERIFICATION ------------------------------------------------------------------------
  ...
  async isRestrictedAccessStatusDivPresent(): Promise<boolean> {
    const restrictedDiv = this.page.locator('div.ui.small.horizontal.label.access-status.restricted');
    return await restrictedDiv.isVisible();
  }
}