...
// FIELDS ------------------------------------------------------------------------------  
  ...
  // Method to fill in the delete confirmation input with the community name
  async fillDeleteConfirmationInput(communityName: string) {
    await this.page.locator('#confirm-delete').fill(communityName);
    console.log(`Filled the delete confirmation input with: ${communityName}`);
  }
...
// BUTTONS -----------------------------------------------------------------------------
  ...
  async clickPermanentlyDeleteButton() {
    await this.page.locator('button.ui.negative.button').click();
