...
// BUTTONS -----------------------------------------------------------------------------
  ...
  async clickDownloadAll() {
    ...
    const downloadAllButton = await this.page.locator('button#download-all');
  ...
  async clickPreview() {
    const previewButton = await this.page.locator('button#preview');
    await previewButton.click();
    console.log('Preview button clicked');
  }

  // Method to click the 'Download' link/button
  async clickDownload() {
    const downloadButton = await this.page.locator('a[role="button"].ui.compact.mini.button[href*="download=1"]');
