...
// FIELDS ------------------------------------------------------------------------------
  ...
  async fillPublicationDateWithToday() {
    ...
    // Click the publication date field and fill it with the formatted date
    await this.page.click('input[name="metadata.publication_date"]');
    await this.page.fill('input[name="metadata.publication_date"]', today);
  }
