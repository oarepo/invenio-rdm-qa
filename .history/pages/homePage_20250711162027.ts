 ...
 * homePage.ts
 *
 * Page Object Model (POM) class for the **Home Page** of the InvenioRDM platform.
 ...
 * ─────────────────────────────────────────────────────────────
 * 💡 TIP:
 * If additional functionality is added to the homepage in the future
 * (e.g., filtering, login prompts, etc.), this class can be extended
 * or split into smaller components (e.g., `HomeSearch`, `HomeFilters`, etc.).
 *
 */
