...
// FIELDS ------------------------------------------------------------------------------
  ...
  async fillUser(): Promise<void> {
    ...
    const comboboxLocator = this.page.locator('//label[text()="User"]//ancestor::form[@class="ui form"]//div[@role="combobox"]//input[@type="text"]');
    await comboboxLocator.fill(userEmail);
    const selectOption = this.page.locator('//label[text()="User"]//ancestor::form[@class="ui form"]//div[@role="combobox"]//div[@role="option"]/div');
...
async clickAcceptAndPublishButton() {
  const button = this.page.locator('button:has-text("Accept and publish")').first();
...
async clickConfirmationAcceptAndPublishButton() {
  const confirmationButton = this.page.locator('button:has-text("Accept and publish")').nth(1);
  ...
  async clickCanEditRadioButton(index: number): Promise<void> {
    const radioButtonLocator = this.page.locator('(//label[text()="Access"]//ancestor::div[@class="required field"]//div[contains(@class,"radio checkbox")])').nth(index-1);
    await radioButtonLocator.click();
  }

  // Method to click the 'Add' button ('Add people' pop-up dialog)
  async clickAddButton(): Promise<void> {
    const addButtonLocator = this.page.locator('button.ui.icon.primary.left.labeled.button', { hasText: 'Add' });
...
// VERIFICATION ------------------------------------------------------------------------
  ...
  async verifyAddedUserForShare(): Promise<boolean> {
    const elementLocator = this.page.locator('//div[contains(@class, "ui image label")]//img[@alt=""]');
  ...
  async isCanEditElementPresent(): Promise<boolean> {
    const elementLocator = this.page.locator('div[role="alert"][class="divider text"]:has-text("Can edit")');
    await this.page.waitForTimeout(1000);
