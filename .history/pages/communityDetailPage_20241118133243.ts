...
// BUTTONS -----------------------------------------------------------------------------
  ...
  // Method to click the 'Accept and publish' button with strict indexing
async clickAcceptAndPublishButton() {
  // Wait for the locator to resolve to the correct number of elements before clicking
  const buttonLocator = this.page.locator('button:has-text("Accept and publish")');
  
  // Ensure we're targeting the first occurrence (index 0) or second occurrence (index 1)
