...
async verifyNoPublicMembersMessagePresent(timeout: number = 5000): Promise<boolean> {
  ...
  try {
    ...
    return true; // Return true if the component is visible
  } catch {
    return false; // Return false if the component does not load within the timeout
  }
}
