...
// BUTTONS -----------------------------------------------------------------------------
  ...
  // Method to click the 'acceptAccessToRecord' checkbox ('Submit for review' pop-up dialog)
  async clickAcceptAccessToRecord() {
    await this.page.click('label[for="acceptAccessToRecord"]');
  }

  // Method to click the 'acceptAfterPublishRecord' checkbox ('Submit for review' pop-up dialog)
  async clickAcceptAfterPublishRecordLabel() {
