...
// FIELDS ------------------------------------------------------------------------------  
 ...
 // Method to fill in the 'Community name' field using the community name from testData
 async fillMetadataTitle() {
    const communityName = testData.upload.communityName(); // Call the function to get the community name
