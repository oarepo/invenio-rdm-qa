...
export class UploadPage {
  ...
  async getRecordDescription(): Promise<string> {
    return await this.page.locator('selector-for-description').innerText(); // Adjust the selector to match your app's structure
  }
  
  async getRecordTitle(): Promise<string> {
    return await this.page.locator('selector-for-title').innerText(); // Adjust the selector to match your app's structure
  }
