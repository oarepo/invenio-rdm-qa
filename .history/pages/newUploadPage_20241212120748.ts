...
// BUTTONS -----------------------------------------------------------------------------
  ...
  async clickCanEditRadioButton(): Promise<void> {
    const radioButtonLocator = this.page.locator('div.field div.ui.radio.checkbox input[type="radio"][value="edit"][aria-label="Can edit"]');
...
// VERIFICATION ------------------------------------------------------------------------
  ...
  async verifyAddedUserForShare(): Promise<boolean> {
    const elementLocator = this.page.locator('(//label[text()="Access"]//ancestor::div[@class="required field"]//div[contains(@class,"radio checkbox")])[3]');
