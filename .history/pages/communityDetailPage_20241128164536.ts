...
// FIELDS ------------------------------------------------------------------------------  
  ...
  async selectCuratorRole() {
    // Use double quotes for the XPath to avoid conflicts with single quotes inside
    await this.page.locator('(//input[@aria-label="Curator"]//ancestor::div[@id="members-users-tab-panel"]//div[contains(@class, "checkbox")])[2]').click();
  }
