 ...
 * communitiesPage.ts
 *
 * Page Object Model (POM) class for the **Communities Page** of the InvenioRDM platform.
 * This class encapsulates all interactions related to searching for, navigating to, and verifying communities.
 * It provides clean, reusable methods for operating on the community list and its search/sort interface.
 *
 * ─────────────────────────────────────────────────────────────────────────────────────────
 * INCLUDES:
 * ─────────────────────────────────────────────────────────────────────────────────────────
 * 1. Navigation:
 *    - Navigate to the homepage or the communities page.
 *    - Open the first community in the "My Communities" list.
 *
 * 2. Interaction:
 *    - Fill in the search input field.
 *    - Select sorting options (Newest, Oldest, Best match).
 *
 * 3. Verification:
 *    - Check whether a community name matches the expected value.
 *    - Validate that the correct sort option is currently selected.
 *
 * ─────────────────────────────────────────────────────────────────────────────────────────
 * EXAMPLE USAGE:
 * ─────────────────────────────────────────────────────────────────────────────────────────
 * const communities = new Communities(page);
 * await communities.navigateToCommunities();
 * await communities.fillSearchField('My Community');
 * await communities.submitSearch();
 * await communities.verifyCommunityName('My Community');
 */
