...
// BUTTONS -----------------------------------------------------------------------------
  ...
  // Method to click confirmation 'Accept' button in 'Accept request' pop up dialog section
  async clickPositiveAcceptButton(): Promise<void> {
    // Locate the button with the class and the "Accept" text
    const acceptButton = this.page.locator('button.ui.icon.positive.left.labeled.button:has-text("Accept")');
