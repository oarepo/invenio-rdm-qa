...
// FIELDS ------------------------------------------------------------------------------  
  ...
  async clickMembersConfirmCheckbox() {
    await this.page.locator('#members-confirm').click({ force: true });
  ...
  async clickRecordsConfirmCheckbox() {
    await this.page.locator('#records-confirm').click({ force: true });
  ...
  async clickSlugConfirmCheckbox() {
    await this.page.locator('#slug-confirm').click({ force: true });
