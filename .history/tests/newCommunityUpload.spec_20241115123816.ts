...
test.describe('New Upload', () => {
  ...
  test.beforeEach(async ({ uploadPage, newCommunity }) => {
    // Assuming these fixtures are provided by your extended test setup
    currentlySelectedType = "your-type";  // Set this to an appropriate value
