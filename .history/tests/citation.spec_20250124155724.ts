...
test.describe('Record Landing Page', () => {
  ...
  test(qase(46, 'Citation'), async () => {
    ...
    console.log('Harvard Format Valid:', isHarvardFormatValid);
     ...
     const hasAuthorHarvard = /^[a-zA-Z]+\s/.test(citationHarvard);
     const hasYearHarvard = /\(\d{4}\)/.test(citationHarvard);
     const hasTitleHarvard = /„.+“\.\s/.test(citationHarvard);
     const hasPublisherHarvard = /CERN\.\s/.test(citationHarvard);
     const hasDoiHarvard = /doi:\s\d{2}\.\d{5}\/[a-z0-9-]+/.test(citationHarvard);
     
     console.log('Contains Author:', hasAuthorHarvard);
     console.log('Contains Year:', hasYearHarvard);
     console.log('Contains Title:', hasTitleHarvard);
     console.log('Contains Publisher:', hasPublisherHarvard);
     console.log('Contains DOI:', hasDoiHarvard);
     
     const componentsHarvard = [hasAuthorHarvard, hasYearHarvard, hasTitleHarvard, hasPublisherHarvard, hasDoiHarvard];
