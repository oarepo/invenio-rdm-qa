...
test.describe('Edit record', () => {
  ...
  test('Edit Existing Record', async () => {
    ...
    expect(actualDescription).toBe(recordDescription, 'The record description does not match the edited value.');
    expect(actualTitle).toBe(recordTitleEdit, 'The record title does not match the edited value.');
