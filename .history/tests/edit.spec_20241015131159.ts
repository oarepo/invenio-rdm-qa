...
// Option 2: Choose based on the parent container, like class or a data-attribute
 const body = page.frameLocator('div.tox-edit-area iframe').locator('body#tinymce');
