...
test.describe('New Upload', () => {
  ...
  test(qase(58, 'Upload a file successfully'), async () => {  
    const qaseData = {
      ...
      description: 'true',    // Set empty string to avoid null values
      preconditions: 'true',  // Set empty string to avoid null values
      postconditions: 'true'  // Set empty string to avoid null values
    };
