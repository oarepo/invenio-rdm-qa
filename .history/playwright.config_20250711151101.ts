...
export default defineConfig({
  ...
  TEST_TIMEOUT: global timeout for each test in milliseconds
  ACTION_TIMEOUT: timeout for individual actions like click or type (does not override explicit timeouts in tests)
  NAVIGATION_TIMEOUT: timeout for page navigation steps

  Example usage from command line:
  TEST_TIMEOUT=120000 ACTION_TIMEOUT=8000 NAVIGATION_TIMEOUT=20000 npx playwright test
  */
