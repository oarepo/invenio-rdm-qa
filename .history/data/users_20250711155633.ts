 ...
 * 
 * - default: The default user credentials for basic login scenarios, which can be overridden by environment variables for flexibility.
 * - existingUser: A known existing user email, for scenarios like invitations.
 * - roles: A collection of alternative user roles with their respective credentials (email and password), used to simulate different permissions and access levels during testing.
 * 
 * Usage:
