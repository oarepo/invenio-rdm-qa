...
export class UIHelper {
  ...
  // Navigate to a specific URL and wait for navigation to finish
  async goto(url: string) {
    // Hardcoded 2-second wait before navigation
    await this.page.waitForTimeout(2000); // Wait for 2 seconds (2000 ms)
