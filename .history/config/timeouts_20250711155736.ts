/**
 * Centralized configuration for various timeout values used across tests.
 * Timeouts can be overridden by environment variables for flexibility in
 * different environments (local, CI, etc.).
 * 
 * Properties:
 ...
 * 
 * This setup ensures consistent timeout management and easy adjustments
